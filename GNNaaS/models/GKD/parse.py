...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--priv_ratio', type=float,
                        default=0.8, help='ratio for privileged nodes/edges')
    ...
    parser.add_argument('--mode', type=str, choices=['pretrain', 'train'],
                        default='train', help='mode for pretrain teacher or train student')
    parser.add_argument('--dist_mode', type=str,
                        default='gkd', help='mode for knowledge distillation')
    ...
    # parser.add_argument('--batch_size', type=int, default=2048*2)#2048
    ...
    parser.add_argument('--include_last', default=False,action='store_true', help='whether include last layer')
