...
from pre_process import data2pkl,data2pkl_Trans_to_Ind,data2pkl_FG_inf
...
def get_default_args():
    ...
    parser.add_argument('--dataset_name', default='YAGO_3-10_isConnectedTo_FG')
    ...
    parser.add_argument('--modelID', type=str, default='YAGO_3-10_isConnectedTo_FG.model')
